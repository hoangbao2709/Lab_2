...
uint8_t so4[8] = {0xE7, 0xE3, 0xE7, 0xE7, 0xE7, 0xE7, 0xC3, 0xC3};
uint8_t so5[8] = {0xC3, 0x81, 0xF9, 0xF9, 0xF3, 0xE7, 0xC1, 0x81};
uint8_t so6[8] = {0xC3, 0x81, 0x99, 0x99, 0x99, 0x99, 0x81, 0xC3};
uint8_t so7[8] = {0xE7, 0xE3, 0xE7, 0xE7, 0xE7, 0xE7, 0xC3, 0xC3};
uint8_t so8[8] = {0xC3, 0x81, 0xF9, 0xF9, 0xF3, 0xE7, 0xC1, 0x81};
uint8_t so9[8] = {0xC3, 0x81, 0xF9, 0xF9, 0xF3, 0xE7, 0xC1, 0x81};
int x = 0;
...
void updateLEDMatrix (int index ){
	uint8_t *binary_array_1 = convert_to_binary_array(getChar(x)[index]);
