...
uint8_t ChuB[8] = {0xC1, 0x99, 0x99, 0xC1, 0x81, 0x99, 0x99, 0xC1};
...
uint8_t DauCach[8] = {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF};
uint8_t so0[8] = {0xC3, 0x81, 0x99, 0x99, 0x99, 0x99, 0x81, 0xC3};
uint8_t so1[8] = {0xE7, 0xE3, 0xE7, 0xE7, 0xE7, 0xE7, 0xC3, 0xC3};
uint8_t so2[8] = {0xC3, 0x81, 0x99, 0x9F, 0xCF, 0xE7, 0x83, 0x81};
uint8_t so3[8] = {0xC3, 0x81, 0xBF, 0x81, 0x81, 0xBF, 0x81, 0xC3};
uint8_t so4[8] = {0x8F, 0x87, 0x93, 0x99, 0x01, 0x01, 0x9F, 0x9F};
uint8_t so5[8] = {0x81, 0x81, 0xF9, 0x81, 0x81, 0x9F, 0x81, 0x81};
uint8_t so6[8] = {0xC3, 0x81, 0x99, 0xF9, 0xC1, 0x99, 0x99, 0xC3};
uint8_t so7[8] = {0x81, 0x81, 0x9F, 0xCF, 0xE7, 0xF3, 0xF9, 0xF9};
uint8_t so8[8] = {0xC3, 0x99, 0x99, 0xC3, 0x99, 0x99, 0x99, 0xC3};
uint8_t so9[8] = {0xC3, 0x81, 0x99, 0x99, 0x83, 0x9F, 0x99, 0xC3};
int x = 0;

uint8_t Chu[37][8] = {
    {0xE7, 0xC3, 0x99, 0x99, 0x81, 0x81, 0x99, 0x99},
	{0xC1, 0x99, 0x99, 0xC1, 0x81, 0x99, 0x99, 0xC1},
	...
	{0xC3, 0x81, 0x99, 0x99, 0x99, 0x99, 0x81, 0xC3},
	{0xE7, 0xE3, 0xE7, 0xE7, 0xE7, 0xE7, 0xC3, 0xC3},
	{0xC3, 0x81, 0x99, 0x9F, 0xCF, 0xE7, 0x83, 0x81},
	{0xC3, 0x81, 0xBF, 0x81, 0x81, 0xBF, 0x81, 0xC3},
	{0x8F, 0x87, 0x93, 0x99, 0x01, 0x01, 0x9F, 0x9F},
	{0x81, 0x81, 0xF9, 0x81, 0x81, 0x9F, 0x81, 0x81},
	{0xC3, 0x81, 0x99, 0xF9, 0xC1, 0x99, 0x99, 0xC3},
